...
const ProjectItem = ({ title, backgroundImg, projectUrl, techStack }) => {
  return (
    <div
      id="projectItem"
      className="relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400 rounded-xl group hover:bg-gradient-to-r from-[#5651e9] to-[#709dff]"
    >
      <Image
      ...
      <div className="hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-40%] w-full px-4 md:px-0 md:w-auto">
        ...
        <Link href={projectUrl}>
          <p className="text-center py-1 md:py-3 md:px-5 rounded-lg bg-white text-gray-700 font-bold text-sm sm:text-base md:text-lg cursor-pointer mx-auto max-w-[100px] md:max-w-[150px]">
            More Info
          </p>
        </Link>
      </div>
