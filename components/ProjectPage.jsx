    ...
    <div className="min-h-screen pb-16 dark:bg-slate-950">
          ...
          <div className="mt-6 grid gap-6 lg:grid-cols-[1.5fr_1fr]">
            <div className="relative overflow-hidden rounded-[2rem] border border-slate-200/70 bg-slate-900 shadow-[0_30px_80px_-40px_rgba(15,23,42,0.8)] dark:border-slate-800 dark:bg-slate-900">
              ...
              <div className="border-t border-slate-200 bg-white p-6 md:p-8 dark:border-slate-800 dark:bg-slate-900">
                <p className="text-xs uppercase tracking-[0.3em] text-[#5651e9]">Project Snapshot</p>
            ...
            <div className="rounded-[2rem] border border-slate-200/70 bg-white p-6 shadow-[0_20px_50px_-35px_rgba(15,23,42,0.7)] dark:border-slate-800 dark:bg-slate-900">
              <p className="text-xs font-semibold uppercase tracking-[0.3em] text-[#5651e9]">
                Stack Focus
              </p>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                {links.map((link) => (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-2 rounded-full border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-900 transition hover:-translate-y-0.5 hover:border-cyan-600 hover:text-cyan-700 dark:border-slate-300 dark:bg-white dark:text-slate-900 dark:hover:bg-slate-200"
                  >
      ...
      <section className="max-w-[1240px] mx-auto grid gap-6 px-4 lg:grid-cols-[2fr_1fr]">
        <article className="rounded-[2rem] border border-slate-200/70 bg-white p-6 dark:border-slate-800 dark:bg-slate-900 md:p-8">
          <p className="text-xs font-semibold uppercase tracking-[0.3em] text-[#5651e9]">Overview</p>
            ...
            <div className="mt-4 space-y-3">
              {techStack.map((item) => (
                <p key={item} className="flex items-center gap-2 text-sm font-medium text-slate-700 dark:text-slate-300">
                  <RiRadioButtonFill className="text-[#5651e9]" />
                  {item}
                </p>
              ))}
            </div>
              ...
              <div className="mt-4 space-y-3">
                {contributors.map((contributor) => (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center gap-2 text-sm font-medium text-slate-700 transition hover:text-cyan-700 dark:text-slate-300 dark:hover:text-cyan-300"
                  >
                    <RiGithubFill />
                    {contributor.name}
                  </a>
